                    ...
                    if subs_subs == 'test':
                        ...
                        for items in lc_files:
                            ...
                            if saved_energy_range == '1000':
                                invoke_period_string = "cd " + path_for_test + " && idl -e FASPER_v2 -args " + path_for_test + "/" + items + " " + path_for_test + "/" + text_gti + " " + results_path + "/" + " " + dir_list + " " + "1 1" + " " + saved_energy_range + " " + pass_detid
...
def plot_results(results_path):
    plot_results_string = "cd " + results_path + " && idl -e plot_fasper_results -args " + results_path
